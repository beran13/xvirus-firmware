...
void desktop_lock_menu_draw_callback(Canvas* canvas, void* model) {
    ...
    for(size_t i = 0; i < DesktopLockMenuIndexTotalCount; ++i) {
        ...
        case DesktopLockMenuIndexDarkMode:
            ...
            enabled = XVIRUS_SETTINGS()->dark_mode;
            break;
        ...
        case DesktopLockMenuIndexBluetooth:
            ...
            break;
        case DesktopLockMenuIndexXvirus:
            icon = &I_CC_Xvirus_16x16;
            break;
    ...
    if(show_lock_menu) {
        ...
        if(event->key == InputKeyBack) {
            ...
            case DesktopLockMenuIndexSettings:
                ...
                break;
            case DesktopLockMenuIndexDarkMode:
                XVIRUS_SETTINGS()->dark_mode = !XVIRUS_SETTINGS()->dark_mode;
                lock_menu->save_xvirus = true;
                break;
            case DesktopLockMenuIndexBluetooth:
                ...
                break;
            case DesktopLockMenuIndexXvirus:
                desktop_event = DesktopLockMenuEventXvirus;
                break;
            default:
                break;
            }
