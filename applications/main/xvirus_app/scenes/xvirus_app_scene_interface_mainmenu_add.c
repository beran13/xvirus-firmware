...
static bool xvirus_app_scene_interface_mainmenu_add_file_browser_callback(
...
void xvirus_app_scene_interface_mainmenu_add_on_enter(void* context) {
    XvirusApp* app = context;
    ...
    const DialogsFileBrowserOptions browser_options = {
        ...
        .skip_assets = true,
        .hide_ext = true,
        .item_loader_callback = xvirus_app_scene_interface_mainmenu_add_file_browser_callback,
...
bool xvirus_app_scene_interface_mainmenu_add_on_event(void* context, SceneManagerEvent event) {
    XvirusApp* app = context;
    bool consumed = false;
...
void xvirus_app_scene_interface_mainmenu_add_on_exit(void* context) {
    UNUSED(context);
}
